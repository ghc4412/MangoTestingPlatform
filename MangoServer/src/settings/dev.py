...
MYSQL_DB_NAME = env('MYSQL_DB_NAME', 'dev_mango_server', aliases=('MYSQL_DATABASE',))
MYSQL_USER = env('MYSQL_USER', 'root')
MYSQL_PASSWORD = env('MYSQL_PASSWORD', '')
MYSQL_IP = env('MYSQL_IP', '127.0.0.1')

# ************************ Debug ************************ #

DEBUG = env_bool('DJANGO_DEBUG', True)
IS_DEBUG_LOG = env_bool('DJANGO_DEBUG_LOG', True)
...
IS_MINIO = env_bool('IS_MINIO', False)
MINIO_STORAGE_ENDPOINT = env('MINIO_STORAGE_ENDPOINT', '127.0.0.1:9000', aliases=('MINIO_ENDPOINT',))
...
MINIO_STORAGE_MEDIA_BUCKET_NAME = env('MINIO_STORAGE_MEDIA_BUCKET_NAME', 'mango-dev', aliases=('MINIO_BUCKET',))
...
IS_SEND_MAIL = env_bool('IS_SEND_MAIL', False)
